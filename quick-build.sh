...
module_list="objs/src/core/nginx.o \
...
cc_options="-c -pipe  -O \
    -Wall -Wextra -Wpointer-arith -Wconditional-uninitialized \
    -Wno-unused-parameter -Wno-deprecated-declarations -Werror \
    -g  -I src/core -I src/event -I src/event/modules \
...
(
    ...
    cc $cc_options -I src/os/unix -I objs \
    ...
    cc -o objs/nginx $module_list -lpcre -lz
